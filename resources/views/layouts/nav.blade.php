    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <!-- Add icons to the links using the .nav-icon class  with font-awesome or any other icon font library -->
            ...
            @if(Auth::user()->is_admin == 1)
                    <li class="nav-item {{ Request::is('admin/stores*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">                    
                            ...
                            @can('user-create')
                            <li class="nav-item">
                                <a href="{{ url($role.'stores/create') }}" class="nav-link {{ Request::is('admin/stores/create*') ? 'active' : '' }}">
                            ...
                            @endcan
                            <li class="nav-item">
                                <a href="{{ url($role.'stores') }}" class="nav-link {{ Request::is('admin/stores') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List All</p>
                                </a>
                            </li>
                  ...
                  @can('user-list')         
                    <li class="nav-item {{ Request::is('users*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">                    
                            ...
                            @can('user-create')
                            <li class="nav-item">
                                <a href="{{ url($role.'users/create') }}" class="nav-link {{ Request::is('users/create*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p> Add New </p>
                                </a>
                            </li>
                            @endcan
                            <li class="nav-item">
                                <a href="{{ url($role.'users') }}" class="nav-link {{ Request::is('users') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List All</p>
                                </a>
                            </li>
            ...
            @can('role-edit', 'role-create', 'role-list', 'role-delete')
            <li class="nav-item {{ Request::is('roles*') ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ url($role.'roles/create') }}" class="nav-link {{ Request::is('roles/create*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Add New </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url($role.'roles') }}" class="nav-link {{ Request::is('roles') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>List All</p>
                        </a>
                    </li>
