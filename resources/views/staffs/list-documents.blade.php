    ...
    <div class="col s12 m2 l2">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <span class="card-title activator grey-text text-darken-4" id="span-"{{$document->id}}"> {!! Form::text('details', $document->details ?? '',  ['class' => 'detail-input', 'id' => 'details-'.$document->id, 'placeholder' => 'Please enter document details']) !!} </span>
          ...
          <a class="btn-floating mb-1 btn-flat waves-effect waves-light  blue accent-2 white-text" href="{{ route('download-files', $document->name)}}" data-target="dropdown2"><i class="material-icons">cloud_download</i></a>
