<div id="discount-modal" class="modal">
    <form id="discountForm" name="discountForm" role="form" method="POST" action="" class="ajax-submit">
        <div class="modal-content">
            <div class="modal-header"><h4 class="modal-title">Discount Form</h4> </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="input-field col m6 s12">
                            {!! Form::select('discount_type', ['amount' => 'Amount', 'percentage' => 'Percentage'] , '' , ['id' => 'discount_type' ,'class' => 'select2 browser-default']) !!}
                        </div>
                        <div class="input-field col m6 s12">
            ...
            <div class="modal-footer">
                <button class="btn waves-effect waves-light modal-action modal-close" type="reset" id="discountresetForm">Close</button>
